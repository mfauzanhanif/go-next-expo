...
func (_u *DepartmentUpdate) AddPositionIDs(ids ...uuid.UUID) *DepartmentUpdate {
	_u.mutation.AddPositionIDs(ids...)
	return _u
}

// AddPositions adds the "positions" edges to the GtkPosition entity.
func (_u *DepartmentUpdate) AddPositions(v ...*GtkPosition) *DepartmentUpdate {
...
func (_u *DepartmentUpdate) RemovePositionIDs(ids ...uuid.UUID) *DepartmentUpdate {
	_u.mutation.RemovePositionIDs(ids...)
	return _u
}

// RemovePositions removes "positions" edges to GtkPosition entities.
func (_u *DepartmentUpdate) RemovePositions(v ...*GtkPosition) *DepartmentUpdate {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *DepartmentUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	_spec.Node.Schema = _u.schemaConfig.Department
...
// AddPositionIDs adds the "positions" edge to the GtkPosition entity by IDs.
func (_u *DepartmentUpdateOne) AddPositionIDs(ids ...uuid.UUID) *DepartmentUpdateOne {
	_u.mutation.AddPositionIDs(ids...)
	return _u
}

// AddPositions adds the "positions" edges to the GtkPosition entity.
func (_u *DepartmentUpdateOne) AddPositions(v ...*GtkPosition) *DepartmentUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemovePositionIDs removes the "positions" edge to GtkPosition entities by IDs.
func (_u *DepartmentUpdateOne) RemovePositionIDs(ids ...uuid.UUID) *DepartmentUpdateOne {
	_u.mutation.RemovePositionIDs(ids...)
	return _u
}

// RemovePositions removes "positions" edges to GtkPosition entities.
func (_u *DepartmentUpdateOne) RemovePositions(v ...*GtkPosition) *DepartmentUpdateOne {
	ids := make([]uuid.UUID, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
