...
func (_q *DepartmentQuery) QueryPositions() *GtkPositionQuery {
...
func (_q *DepartmentQuery) WithPositions(opts ...func(*GtkPositionQuery)) *DepartmentQuery {
	query := (&GtkPositionClient{config: _q.config}).Query()
...
func (_q *DepartmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Department, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.Department
	...
	if query := _q.withPositions; query != nil {
		if err := _q.loadPositions(ctx, query, nodes,
			func(n *Department) { n.Edges.Positions = []*GtkPosition{} },
			func(n *Department, e *GtkPosition) { n.Edges.Positions = append(n.Edges.Positions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DepartmentQuery) loadPositions(ctx context.Context, query *GtkPositionQuery, nodes []*Department, init func(*Department), assign func(*Department, *GtkPosition)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(gtkposition.FieldDepartmentID)
	}
...
func (_q *DepartmentQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.Department)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
