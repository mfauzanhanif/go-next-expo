...
func (_u *UserUpdate) AddTenantUserIDs(ids ...uuid.UUID) *UserUpdate {
...
func (_u *UserUpdate) RemoveTenantUserIDs(ids ...uuid.UUID) *UserUpdate {
...
// AddTenantUserIDs adds the "tenant_users" edge to the TenantUser entity by IDs.
func (_u *UserUpdateOne) AddTenantUserIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.AddTenantUserIDs(ids...)
	return _u
}
...
// RemoveTenantUserIDs removes the "tenant_users" edge to TenantUser entities by IDs.
func (_u *UserUpdateOne) RemoveTenantUserIDs(ids ...uuid.UUID) *UserUpdateOne {
	_u.mutation.RemoveTenantUserIDs(ids...)
	return _u
}
