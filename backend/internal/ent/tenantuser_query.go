...
func (_q *TenantUserQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TenantUserQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *TenantUserQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *TenantUserQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *TenantUserQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *TenantUserQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *TenantUserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*TenantUser, error) {
	...
	_spec.Node.Schema = _q.schemaConfig.TenantUser
...
func (_q *TenantUserQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*TenantUser, init func(*TenantUser), assign func(*TenantUser, *Tenant)) error {
	...
	nodeids := make(map[uuid.UUID][]*TenantUser)
	for i := range nodes {
		fk := nodes[i].TenantID
...
func (_q *TenantUserQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tenantuser.Table, tenantuser.Columns, sqlgraph.NewFieldSpec(tenantuser.FieldID, field.TypeUUID))
	_spec.From = _q.sql
...
func (_q *TenantUserQuery) sqlQuery(ctx context.Context) *sql.Selector {
	...
	t1.Schema(_q.schemaConfig.TenantUser)
	ctx = internal.NewSchemaConfigContext(ctx, _q.schemaConfig)
