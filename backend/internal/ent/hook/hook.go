...
// The GtkFunc type is an adapter to allow the use of ordinary
// function as Gtk mutator.
type GtkFunc func(context.Context, *ent.GtkMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GtkFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GtkMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GtkMutation", m)
}

// The GtkPositionFunc type is an adapter to allow the use of ordinary
// function as GtkPosition mutator.
type GtkPositionFunc func(context.Context, *ent.GtkPositionMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f GtkPositionFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.GtkPositionMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.GtkPositionMutation", m)
}
