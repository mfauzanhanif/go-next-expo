...
│ ├── docker-compose.prod.yaml # Override konfigurasi khusus untuk lingkungan produksi
│ └── docker-swarm.yaml # (Opsional) Konfigurasi jika orkestrasi menggunakan Docker Swarm
...
├── prometheus.yaml # Target scraping metrik (dari Echo backend, PostgreSQL, Node.js)
└── otel-collector.yaml # Konfigurasi OpenTelemetry untuk melacak latensi request API
