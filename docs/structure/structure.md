...
│   └── /workflows                  
│       ├── build-and-test.yml      # CI: Menjalankan linter, test, dan build (Frontend & Backend)
│       └── deploy-production.yml   # CD: Otomatisasi rilis ke server produksi menggunakan Docker
